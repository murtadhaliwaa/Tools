...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-lg px-2.5 py-2 text-sm outline-hidden select-none transition-colors",
        "hover:bg-muted/80 data-highlighted:bg-accent data-highlighted:text-accent-foreground",
      ...
      {...props}
    >
      <SelectPrimitive.ItemText className="flex min-w-0 flex-1 text-start whitespace-nowrap">
        {children}
