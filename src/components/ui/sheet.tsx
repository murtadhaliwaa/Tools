  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition duration-300 ease-out",
          ...
          // يمين: انزلاق من خارج الشاشة يميناً نحو اليسار (بدون عكس RTL)
          ...
          // يسار: انزلاق من خارج الشاشة يساراً نحو اليمين
