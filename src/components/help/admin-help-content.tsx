...
const FAQ = [
  ...
  },
  {
    ...
    a: "الحذف من الكتالوج إخفاء من القوائم (ناعم) وليس مسحاً للحركات. لا يوجد زر استعادة في الواجهة حالياً — راجع المورّد إن لزم. لكل أداة حد أدنى للتنبيه (0 = بلا تنبيه)؛ عند الكمية ≤ الحد تظهر شارة وتنبيه في لوحة التحكم.",
  },
  {
    q: "كيف أطلع تقرير صرف الأسبوع؟",
    a: "من التقارير → تقرير الصرف. يُحمّل تلقائياً من الاثنين حتى اليوم. يمكن تغيير الفترة أو تصفية بمكينة/مادة، ثم تصدير Excel أو PDF.",
  },
  {
    q: "كيف أطلع جرد المخزون كامل؟",
    a: "من التقارير → جرد المخزون. يعرض كل المواد ورصيدها (العدد) والحالة، ويمكن تصدير Excel أو PDF. استخدم الفلاتر حسب التصنيف أو الحالة أو «منخفض / نفد».",
  },
  {
    q: "ملف Excel ناقص؟",
    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-3 text-sm">
          ...
          <Link href="/reports/issues" className="underline underline-offset-2">
            تقرير الصرف
          </Link>
          <Link href="/reports/inventory" className="underline underline-offset-2">
            جرد المخزون
          </Link>
